...
if (n == 10) {
    ...
    <p class="achievement-description">You're visiting my website for the 10th time.</p>
    </div>`;
...
if (n == 1) {
    ...
    <p class="achievement-description">You're visiting my website for the 1st time.</p>
    </div>`;
    const tl = gsap.timeline({defaults: {duration: 0.75}})
    tl.fromTo('.achievement-container', {y: 50, opacity:0}, {y: 0, opacity:1}, "+=5.00")
    document.getElementById('achievement-close').addEventListener('click', event => {
